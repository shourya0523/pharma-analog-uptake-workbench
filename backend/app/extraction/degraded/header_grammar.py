"""The header grammar: reading column meaning from header vocabulary.

Degraded mode only. This is the interpreter the model replaced: a
vocabulary of period phrases, geography labels and change markers,
composed into candidate layouts from how they repeat. It is kept for runs
with no model and is never scored.
"""
